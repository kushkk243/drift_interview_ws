...
: ${AMENT_CURRENT_PREFIX:="/home/kushkk/drift_ws/install/robot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_description/environment/robot_description.sh"
